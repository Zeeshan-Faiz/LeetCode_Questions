...
(i.e., binary search tree), construct the tree and return its root. It is guaranteed that there is 
always possible to find a binary search tree with the given requirements for the given test cases.
...
than Node.val. A preorder traversal of a binary tree displays the value of the node first, then 
